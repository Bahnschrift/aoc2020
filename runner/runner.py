...
def run_part(part: int, mod: Any, data: list):
    funcname = f'part_{part}'
...
def get_data(day):
    ...
    fname = "./inputs/" + format_filename(day) + ".txt"
    try:
...
def run(day, year=2020):
    ...
    # print(format_filename(day))
    mod = __import__("py." + format_filename(day))
    data = get_data(day)
